			...
			<div className='relative grid grid-cols-1 md:grid-cols-2 gap-20'>
				...
				<div className='flex justify-between flex-col py-4'>
					<motion.div
						...
						<motion.div className='text-lg text-muted-foreground mt-8 leading-relaxed'>
					...
					<div className='flex gap-4 pt-12 md:pt-0'>
						<button
							onClick={handlePrev}
							className='h-10 w-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary transition-all group'>
							<IconArrowLeft className='h-5 w-5 group-hover:text-primary-foreground' />
						</button>
						<button
							onClick={handleNext}
							className='h-10 w-10 rounded-full bg-secondary flex items-center justify-center hover:bg-primary transition-all group'>
							<IconArrowRight className='h-5 w-5 group-hover:text-primary-foreground' />
						</button>
					</div>
				</div>
			</div>
